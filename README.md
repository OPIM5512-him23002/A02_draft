...
-  Install required packages in the repo directory: pip install -r requirements.txt
-  Run the code : python src/code.py
## Outputs
Two scatter plots representing model performance for train and test sets would be generated in the figs/ directory.
## Contributors
